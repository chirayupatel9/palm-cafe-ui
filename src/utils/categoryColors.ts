...
const categoryColors: CategoryColorScheme[] = [
  {
    name: 'primary',
...
export const getCategoryColor = (categoryName: string | null | undefined, index = 0): CategoryColorScheme => {
  if (!categoryName) {
...
export const getCategoryColorByIndex = (index: number): CategoryColorScheme => {
  return categoryColors[index % categoryColors.length];
};

export const getAllCategoryColors = (): CategoryColorScheme[] => {
