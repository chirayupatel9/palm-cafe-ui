...
const INITIAL_CAFE_SETTINGS: CafeSettings = {
  ...
  light_primary_color: '#334b26',
  light_secondary_color: '#91590b',
  light_accent_color: '#a57f42',
  light_background_color: '#e1e5df',
  light_text_color: '#0b0f05',
  light_surface_color: '#e1e5df',
  dark_primary_color: '#334b26',
  dark_secondary_color: '#91590b',
  dark_accent_color: '#a57f42',
  dark_background_color: '#0b0f05',
  dark_text_color: '#e1e5df',
  dark_surface_color: '#253419'
};
...
function processCafeSettingsData(data: Record<string, unknown>): CafeSettings {
  return {
    ...
    light_primary_color: (data.light_primary_color as string) || '#334b26',
    light_secondary_color: (data.light_secondary_color as string) || '#91590b',
    light_accent_color: (data.light_accent_color as string) || '#a57f42',
    light_background_color: (data.light_background_color as string) || '#e1e5df',
    light_text_color: (data.light_text_color as string) || '#0b0f05',
    light_surface_color: (data.light_surface_color as string) || '#e1e5df',
    dark_primary_color: (data.dark_primary_color as string) || '#334b26',
    dark_secondary_color: (data.dark_secondary_color as string) || '#91590b',
    dark_accent_color: (data.dark_accent_color as string) || '#a57f42',
    dark_background_color: (data.dark_background_color as string) || '#0b0f05',
    dark_text_color: (data.dark_text_color as string) || '#e1e5df',
    dark_surface_color: (data.dark_surface_color as string) || '#253419',
