 ...
 * @param {{ categories: Array<{ title: string; icon: React.ElementType; stocks: Array<{ name: string; ticker: string; price: number; change: number }> }}> }} props
 */
export const StockCategoryList = ({ categories }) => {
  return (
