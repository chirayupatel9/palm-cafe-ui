...
const GalleryModal: React.FC<GalleryModalProps> = ({ selectedItem, isOpen, onClose, setSelectedItem, mediaItems }) => {
...
const InteractiveBentoGallery: React.FC<InteractiveBentoGalleryProps> = ({ mediaItems, title, description }) => {
  ...
  const [items, setItems] = useState<BentoMediaItem[]>(mediaItems);
