                ...
                <div className="flex flex-col sm:flex-row justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  {selectedInvoice.order_number && (
                    <button
                      ...
                      className="px-4 py-2 min-h-[44px] text-sm font-medium text-white bg-secondary-600 hover:bg-secondary-700 rounded-lg transition-colors flex items-center justify-center"
                    >
