...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Theme tokens - single source from theme/theme.css
        primary: {
        ...
        accent: {
          ...
          50: 'var(--color-accent-50, #fdf8f3)',
          100: 'var(--color-accent-100, #fbf1e8)',
          200: 'var(--color-accent-200, #f6e3d1)',
          300: 'var(--color-accent-300, #f0d0b5)',
          400: 'var(--color-accent-400, #e8b88d)',
        ...
        // Legacy aliases - map to theme
        'background-light': 'var(--surface-page)',
        'background-dark': 'var(--surface-page)',
        'text-light': 'var(--color-on-surface)',
        'text-dark': 'var(--color-on-surface)',
        'text-subtle-light': 'var(--color-on-surface-variant)',
        'text-subtle-dark': 'var(--color-on-surface-variant)',
        'card-light': 'var(--surface-card)',
